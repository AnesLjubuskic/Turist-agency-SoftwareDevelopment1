...
namespace RS1Seminarski.Migrations
{
    ...
    [Migration("20220906000757_GrupeOsoba")]
    partial class GrupeOsoba
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RS1Seminarski.Hubs.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RS1Seminarski.Hubs.Notifications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RS1Seminarski.Modul.Models.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RS1Seminarski.Modul_Smjestaj.Models.Grupe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("PutovajeId");

                    b.HasIndex("VodicId");

                    b.ToTable("GrupePutovanja");
                });

            modelBuilder.Entity("RS1Seminarski.Modul_Smjestaj.Models.Osoba", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RS1Seminarski.Modul_Smjestaj.Models.PlanProgram", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RS1Seminarski.Modul_Smjestaj.Models.Grupe", b =>
                {
                    b.HasOne("RS1Seminarski.Modul_Smjestaj.Models.Putovanje", "Putovanje")
                        .WithMany()
                        .HasForeignKey("PutovajeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RS1Seminarski.Modul.Models.Vodic", "Vodic")
                        .WithMany()
            ...
            modelBuilder.Entity("RS1Seminarski.Modul_Smjestaj.Models.Osoba", b =>
                {
                    b.HasOne("RS1Seminarski.Modul_Smjestaj.Models.Grupe", null)
                        .WithMany("Korisnici")
